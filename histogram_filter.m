...
% if size(svm_left_idx, 2) == 0
%     svm_data = [0, 0, 0, 0, 0, 0,svm_data];
% elseif size(svm_left_idx, 2) == 1
%     svm_data = [0, 0, 0, 0, 0,svm_data];
% elseif size(svm_left_idx, 2) == 2
%     svm_data = [0, 0, 0, 0,svm_data];
% elseif size(svm_left_idx, 2) == 3
%     svm_data = [0, 0, 0,svm_data];
% elseif size(svm_left_idx, 2) == 4
%     svm_data = [0, 0,svm_data];
% elseif size(svm_left_idx, 2) == 5
%     svm_data = [0, svm_data];
% end
% 
% if size(svm_right_idx, 2) == 0
%     svm_data = [svm_data, 0, 0, 0, 0, 0, 0];
% elseif size(svm_right_idx, 2) == 1
%     svm_data = [svm_data, 0, 0, 0, 0, 0];
% elseif size(svm_right_idx, 2) == 2
%     svm_data = [svm_data, 0, 0, 0, 0];
% elseif size(svm_right_idx, 2) == 3
%     svm_data = [svm_data, 0, 0, 0];
% elseif size(svm_right_idx, 2) == 4
%     svm_data = [svm_data, 0, 0];
% elseif size(svm_right_idx, 2) == 5
%     svm_data = [svm_data, 0];
% end
...
if model == "angel"
    load('rad_m.mat') ;
    [peak_num, ~, ~] = svmpredict(label, svm_data, rad_m); % 測試訓練數據
else
    load('scale_m.mat') ;
    [peak_num, ~, ~] = svmpredict(label, svm_data, scale_m); % 測試訓練數據
end

% label = [0];
% [peak_num, ~, ~] = svmpredict(label, svm_data, model); % 測試訓練數據
