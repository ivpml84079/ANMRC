...
- **VLFeat** 0.9.21
- **Note:** Please download VLFeat from its homepage (www.vlfeat.org), and place the extracted VLFeat folder in the same directory as the source code.
...
After placing VLFeat and the source code in the same directory, run ```demo.m```.
...
Yu-Qi Zhang: <M11315029@mail.ntust.edu.tw>
